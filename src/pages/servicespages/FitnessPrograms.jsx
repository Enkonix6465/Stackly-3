...
const FitnessPrograms = () => {
  ...
  const programs = [
    ...
    },
    {
      ...
      description: "Improve heart health and endurance with dynamic cardio workouts"
    },
    {
      title: "HIIT Training Sessions",
      description: "High-intensity interval training for maximum fat burning and fitness"
    },
    {
    ...
    },
    {
      ...
      description: "One-on-one customized fitness plans for your specific goals"
    },
    {
      title: "Group Fitness Classes",
      description: "Motivating group sessions for all fitness levels and preferences"
    }
  ];
      ...
      <section className="w-full h-screen flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-16 relative overflow-hidden max-w-full">
        ...
        <div className="relative z-10 text-center max-w-4xl px-4 w-full">
          ...
          <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl text-white mb-8 sm:mb-10 max-w-4xl mx-auto leading-relaxed" data-aos="fade-up" data-aos-delay="200">
            Transform your body and mind with comprehensive fitness programs designed for all levels and goals.
          </p>
        ...
        <div className="max-w-7xl mx-auto w-full overflow-hidden">
          <div className="text-center mb-16" data-aos="fade-up" data-aos-delay="200" data-aos-once="false">
            ...
            <p className={`text-base sm:text-lg max-w-2xl mx-auto ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Transform your life with the proven benefits of regular fitness training and exercise programs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 items-center">
            ...
            <div className="space-y-4 sm:space-y-6" data-aos="fade-right" data-aos-delay="300" data-aos-once="false">
              ...
              >
                ...
                <p className={`text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  Develop muscle mass and increase overall strength through progressive resistance training and targeted exercises designed for all fitness levels.
                </p>
              </div>
              ...
              >
                ...
                <p className={`text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  Improve heart health and circulation through cardio exercises that strengthen your cardiovascular system and boost endurance.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col items-center text-center" data-aos="zoom-in" data-aos-delay="600" data-aos-once="false">
              ...
              <p className={`text-lg max-w-md ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                Experience the profound benefits of fitness training that will enhance your physical strength, endurance, and overall well-being.
              </p>
            </div>
            ...
            <div className="space-y-4 sm:space-y-6" data-aos="fade-left" data-aos-delay="300" data-aos-once="false">
              ...
              >
                ...
                <p className={`text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  Achieve and maintain your ideal weight through effective fitness programs that boost metabolism and burn calories efficiently.
                </p>
              </div>
              ...
              >
                ...
                <p className={`text-base ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  Increase your energy levels and vitality through regular exercise that enhances your metabolism and overall physical performance.
                </p>
              </div>
            </div>
          </div>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                    Access to {feature.toLowerCase()} for enhanced fitness experience and comprehensive support.
                  </p>
                </div>
              ))}
            </div>
        ...
        <div className="max-w-6xl mx-auto text-center w-full overflow-hidden">
          <div className={`rounded-3xl p-8 sm:p-12 ${isDarkMode ? 'bg-black' : 'bg-white'}`} data-aos="fade-up">
            ...
            <p 
              ...
              data-aos-once="false"
            >
              Get access to personalized fitness programs and training tools to improve your strength, endurance, and overall health.
            </p>
