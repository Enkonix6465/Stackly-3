       ...
       <section className={`w-full py-12 sm:py-16 px-4 ${isDarkMode ? 'bg-teal-500' : 'bg-teal-500'}`}>
         <div className="max-w-7xl mx-auto">
           ...
           <div className="overflow-x-auto">
             ...
             <section className={`w-full py-12 sm:py-16 px-4 ${isDarkMode ? 'bg-black' : 'bg-teal-50'}`}>
               <div className="max-w-7xl mx-auto">
                 <h2 className={`text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 ${isDarkMode ? 'text-white' : 'text-teal-700'}`}>
                 ...
                 <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
                   ...
                   <div className="flex justify-center">
                     <div className="relative w-[300px] h-[300px] sm:w-[400px] sm:h-[400px] lg:w-[500px] lg:h-[500px]">
                       {/* Center */}
                       <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-full ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-2xl flex items-center justify-center z-20 border-4 border-teal-500`}>
                       ...
                       <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-full" style={{ zIndex: 15 }}>
                         ...
                         <div 
                           ...
                           className={`absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-full flex flex-col items-center justify-center cursor-pointer hover:scale-125 hover:z-50 transition-all duration-300 shadow-xl border-2 border-white ${
                         ...
                         >
                           ...
                           <span className="text-[8px] sm:text-[9px] lg:text-[10px] text-white font-bold">FITNESS</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[8px] text-white font-bold text-center">HEALTHY<br/>EATING</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[8px] text-white font-bold text-center">WEIGHT<br/>LOSS</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[10px] text-white font-bold">WELLNESS</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[8px] text-white font-bold text-center">HEALTHY<br/>MIND</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[10px] text-white font-bold">SLEEP</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[7px] text-white font-bold text-center leading-tight">STRESS<br/>MANAGEMENT</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[10px] text-white font-bold">MEDITATION</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[10px] text-white font-bold">NUTRITION</span>
                         </div>
                         ...
                         >
                           ...
                           <span className="text-[10px] text-white font-bold">SELF CARE</span>
                         </div>
                       </div>
                     </div>
                   </div>
